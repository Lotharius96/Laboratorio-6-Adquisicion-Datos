...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("d67660c5-2db9-4d75-98de-ebaea1d2c747/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83336416.7807542"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_385),
	...
	cy_psoc3_pins_v1_10
		#(.id("d67660c5-2db9-4d75-98de-ebaea1d2c747/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1041f446-a5ae-47c8-b7b3-3c97d04e0f76/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module Keypad_V1_0_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("c6b54b57-c79b-4289-acab-060400a22632/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
	...
	cy_psoc3_pins_v1_10
		#(.id("c6b54b57-c79b-4289-acab-060400a22632/4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  .drive_mode(12'b010_010_010_010),
		  .ibuf_enabled(4'b1_1_1_1),
		  .init_dr_st(4'b1_1_1_1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("c6b54b57-c79b-4289-acab-060400a22632/bc4b7ffd-2f5b-4cbc-a18a-d257f87549b6"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
